...
public class App {
	public static void main(String[] args) {
		...
		//String[] occupation = { "Q40348", "Q40348", "Q937857", "Q10800557", "other", "any" };
		String[] nationality = { "Q30", "Q183", "Q148", "Q38", "other", "any" };
		String[] attribute = { "P40", "P19", "P102", "P69" };
		...
		qe = QueryExecutionFactory.create("select ?item ?label where {?item <http://www.wikidata.org/prop/direct/P31> <http://www.wikidata.org/entity/Q2133344>.OPTIONAL { ?item <http://www.w3.org/2000/01/rdf-schema#label> ?label . FILTER (lang(?label)=\"en\") }  }", model);
